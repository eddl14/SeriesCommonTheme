...
-- INSERT INTO utilisateur (prenomUtilisateur,nomUtilisateur,username,password,email,dateNaissance,usercanonical,emailcanonical,enabled,salt,last_login,locked,expired,expires_at,confirmation)
...
INSERT INTO acteur (prenomActeur,nomActeur,photo)
VALUES ('Peter','Dinklage','http://www.celebritybeliefs.com/wp-content/uploads/2016/06/Peter-Dinklage.jpg'

),
('Kit','Harington','https://wallpaperscraft.com/image/kit_harington_actor_beard_look_105092_602x339.jpg

'),
('Emilia','Clarke','http://www.gossipcop.com/wp-content/uploads/2015/06/Emilia-Clarke-Jimmy-Kimmel-Fans-Fight.jpg

'),
('Lena','Headey','http://www.thevibe.fr/upload/external/thevibe577659973e2f9.jpg'),
('Maisie','Williams',''),
('Sophie','Turner',''),
('Bryan','Cranston',''),
('Anna','Gunn',''),
